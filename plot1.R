...
totalEmissionsOnYear <- with(NEI,tapply(Emissions,year,FUN = sum))
barplot(totalEmissionsOnYear, xlab = "year", ylab = " Amount of PM2.5 emitted (tons)", main = "Total Emissions by years")
